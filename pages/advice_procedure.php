<?php
    ...
    if (isset($_POST['makeSlip'])) {
        ...
        $insertQuery = mysqli_query($connect, "
        INSERT INTO `doctor_prescription`( `doctor_id`, `pat_id`, `doctor_advice`, `pat_procedure`, `stiches`, `visit`, `cathetor`) 
        VALUES 
        ('$doctor_id', '$pat_id', '$doctorAdvice', '$procedureCounter', '$stitchesDays', '$visitAfterDays', '$catheterAfterDays')");

        if ($insertQuery) {
            header("LOCATION: doctor_patient_list.php");
        }
    }
                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-12 m-t-30">
                                        ...
                                        <textarea class="form-control" name="doctorAdvice" rows="5" required="" placeholder="Tab1: Example 1 + 0 + 0, Tab2: Example 0 + 0 + 1, Tab3: Example 1 + 0 + 1, Tab4: Example 1 + 1 + 1"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- <form method="POST"> -->
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" name="procedureCounter"  rows="5" placeholder="Procedure, Surgery here . . ." required></textarea>
                                </div>
                            </div>
                        ...
                        <!-- </form> -->
                            <div class="d-print-none mo-mt-2">
                                <div class="float-right">
                                    ...
                                    <button class="btn btn-primary waves-effect waves-light btn-lg" type="submit" name="makeSlip">Submit</button>
