        ...
        <div class="row">
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        <h4 class="mt-0 header-title text-center">Doctors Credentials List</h4>
                                ...
                                <?php
                                    ...
                                    while ($rowMembers = mysqli_fetch_assoc($selectQueryMembers)) {
                                        if ($rowMembers['category_id'] === '3') {   
                                            if ($rowMembers['login_credentials'] === '1') {
                                                echo '
                                                <tr>
                                                    <td>'.$iteration++.'</td>
                                                    <td>'.$rowMembers['name'].'</td>
                                                    <td>'.$rowMembers['category_name'].'</td>
                                                    <td class="text-center"><a href="resend_credentials.php?id=0'.$rowMembers['contact'].'" type="button" class="btn text-white btn-secondary waves-effect waves-light btn-sm">Resend Credentials</a></td>
                                                </tr>';
                                            }
                                        }
                                    }
