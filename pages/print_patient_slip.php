<?php
    ...
    $selectQuery = mysqli_query($connect, "SELECT patient_registration.*, staff_members.name, area.area_name, patient_registraion_date.pat_date FROM `patient_registration`
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12" align="left">
                                        ...
                                        <div style="display: flex;">
                                            ...
                                            <?php
                                                $dateAdmisison = $fetch_selectQuery['pat_date']; 
