...
if (isset($_POST["addExpense"])) {
	...
	$createUser = mysqli_query($connect, "INSERT INTO expense(cat_id, expense_amount, expense_date, expense_description)VALUES('$expenseCategory', '$expenseAmount', '$expenseDate', '$expenseDescription')");
