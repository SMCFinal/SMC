<?php
    ...
    $queryDoctorCharges = mysqli_query($connect, "SELECT doctor_surgery_charges.*, rooms.room_number, discharge_patients.patient_doa, discharge_patients.patient_name, discharge_patients.patient_doop, surgeries.surgery_name, staff_members.name, discharge_patients.organization FROM `doctor_surgery_charges` 
        ...
        WHERE doctor_surgery_charges.payment_status = '1' AND discharge_patients.organization LIKE '%Other%'  AND doctor_surgery_charges.pat_consultant = '$id' GROUP BY doctor_surgery_charges.pat_id ORDER BY discharge_patients.patient_doa DESC");
...
<div class="page-content-wrapper ">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title">Other Patients Surgery Charges </h5>
            </div>
        </div>
        <!-- end row -->
        <div class="row">
                            ...
                            <table class="table mb-0">
                                ...
                                <tbody>
                                    ...
                                    $queryVisits = mysqli_query($connect, "SELECT doctor_visit_charges.*, discharge_patients.patient_name, surgeries.surgery_name, rooms.room_number, discharge_patients.organization  FROM `doctor_visit_charges`
                                        ...
                                        WHERE doctor_visit_charges.visit_status = '0' AND doctor_visit_charges.charges_status = '1' AND discharge_patients.organization LIKE '%Other%' AND doctor_visit_charges.doctor_id = '$id'");
