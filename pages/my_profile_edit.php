<?php
    ...
    if (isset($_POST['changePassword'])) {
        ...
        $updateQuery = mysqli_query($connect, "UPDATE login_user SET password = '$password' WHERE id = '$id'");
        if ($updateQuery) {
            $description = "Password reset successful. Your new password is: ".$password.". Thank You! SMC";
                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <div class=" float-right">
                                <?php
                                    echo '<button type="submit" name="changePassword" class="btn text-white btn-primary waves-effect waves-light">Submit!</button>';
                                ?>
                            </div>
                                ...
                                <table class="table mb-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input required type="text" class="form-control" placeholder="Enter password"  name="password" value="<?php echo $fetch_loginUser['password'] ?>"></td>
                                        ...
                                        <tr>
                                            ...
                                            <input required type="hidden" class="form-control" placeholder="Enter password"  name="contact" value="0<?php echo $fetch_staffMembers['contact'] ?>">
