...
<div class="page-content-wrapper ">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title">OT Report</h5>
            </div>
        </div>
        <!-- end row -->
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST">
                           <!--  <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Select Ex</label>
                                <div class="col-sm-6">
                                    <?php
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <a href="report_ot_list.php" type="submit" name="addMedicine" class="btn btn-primary waves-effect waves-light">Report</a>
                                    <!-- <button ></button> -->
                                </div>
                            </div>
                        </form>
