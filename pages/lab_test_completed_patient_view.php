        ...
        <div class="row">
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body">
                            <a href="lab_test_completed.php" class="btn btn-primary waves-effect waves-light"><i class="fa fa-arrow-left"></i></a>
                                <?php
                                  $file_query = mysqli_query($connect, "SELECT uploaded_file FROM lab_test_report WHERE reference_no = '$id'");
                                  $fetch_fileQuery = mysqli_fetch_array($file_query);
                                  $file = $fetch_fileQuery[0];
                                  $testFile = explode("/", $file);
                                  $testFileView = $testFile[2];
                                  echo'
                                    <div align="right">
                                      <a href="../_labFiles/'.$testFileView.'" _blank="" type="button" class="btn btn-success btn-lg waves-effect waves-light">Download Test Result <i class="fa fa-download"></i></a>
                                    </div>';
                                ?>
                                <!-- <a href="lab_test_completed.php" > </a> -->
