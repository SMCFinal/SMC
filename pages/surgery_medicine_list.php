                    ...
                    <div class="card-body">
                                    ...
                                    echo '
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="./surgery_medicine_edit.php?id='.$rowMedicines['id'].'" class="btn btn-warning"  name="Deleteme" data-original-title="Deactivate User Access">Edit</a>
                                            </td>
                                            <td class="text-center">
                        ...
                        function deleteme(delid){
                          if (confirm("Do you want to delete medicine?")) {
                            window.location.href = 'surgery_medicine_delete.php?del_id='+delid;
                            return true;
                          }
                        }
                      </script>
