                                        ...
                                        if ($rowMembers['category_id'] === '2') {   
                                            if ($rowMembers['login_credentials'] === '0') {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><a href="generate_ana_login.php?id='.$rowMembers['staffId'].'" type="button" class="btn text-white btn-secondary waves-effect waves-light btn-sm">Generate Credentials</a></td>
                                                </tr>';
                                            }else {
                                                echo '
                                                <tr>
                                                    ...
                                                    <td>'.$rowMembers['name'].'</td>
                                                    <td>'.$rowMembers['category_name'].'</td>
                                                    <td class="text-center"><a href="resend_ana_login.php?id='.$rowMembers['staffId'].'" type="button" class="btn text-white btn-secondary waves-effect waves-light btn-sm">Resend Credentials</a></td>
                                                </tr>';
                                            }
                                        }
                                    }
