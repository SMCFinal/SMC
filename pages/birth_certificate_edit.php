<?php
    ...
    $certificateData = mysqli_query($connect, "SELECT * FROM birth_certificate WHERE certificate_id = '$cert_id'");
    $fetch_certificateData = mysqli_fetch_assoc($certificateData);
    ...
    if (isset($_POST['updateCertificate'])) {
        ...
        $insertQuery = mysqli_query($connect, "UPDATE `birth_certificate` SET 
            `certificate_date` = '$certificate_date',
             `baby_gender` = '$baby_gender',
              `baby_weight` = '$baby_weight',
               `baby_father` = '$baby_father',
...
<div class="page-content-wrapper ">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title">Update Birth Certificate</h5>
            </div>
        </div>
        <!-- end row -->
        <div class="row">
                    ...
                    <div class="card-body">
                        <form method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" value="<?php echo $fetch_certificateData['certificate_date'] ?>" placeholder="Admission Charges" type="date" name="certificate_date" required="">
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control gender" name="baby_gender" required="" style="width:100%">
                                        ...
                                        <?php
                                        if ($fetch_certificateData['baby_gender'] === '1') {
                                            echo '
                                                <option value="1" selected>Male</option>
                                                <option value="2">Female</option>
                                            ';
                                        }elseif ($fetch_certificateData['baby_gender'] === '2') {
                                            echo '
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" value="<?php echo $fetch_certificateData['baby_weight'] ?>" placeholder="Weight in KG" type="text" name="baby_weight" required="">
                                </div>

                                <label for="example-text-input" class="col-sm-2 col-form-label">Father Name</label>
                                <div class="col-sm-4">
                                    <input class="form-control" value="<?php echo $fetch_certificateData['baby_father'] ?>" placeholder="Father Name" type="text" name="baby_father" required="">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" value="<?php echo $fetch_certificateData['baby_address'] ?>" placeholder="Address" type="text" value="<?php echo $fetch_dischargePatient['patient_address'] ?>" name="baby_address" required="">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <button type="submit" class="btn btn-primary waves-effect waves-light" name="updateCertificate">Update Certificate</button>
                                </div>
                            </div>
                        </form>
                        <h5>
