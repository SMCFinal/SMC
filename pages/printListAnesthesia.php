...
<div class="page-content-wrapper " >
    <div class="container-fluid"><br>
        <div class="row">
            <div class="col-sm-12">
                <h5 class="page-title d-inline" >Anesthetic Charges</h5>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table mb-0">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                $chargesQuery = mysqli_query($connect, "SELECT * FROM `anes_confirm_charges_list` WHERE ref_no = '$ref' AND anes_id = '$id' ORDER BY op_time DESC");
                                                                ...
                                                                while ($chargesQueryFetch = mysqli_fetch_assoc($chargesQuery)) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>'.$chargesQueryFetch['op_time'].'</td>
                                                                        <td>'.$chargesQueryFetch['an_charges'].'</td>';

                                                                        $sumVisitAmount = $sumVisitAmount + $chargesQueryFetch['an_charges'];
                                                                        echo '
                                                                    </tr>
                                                                    ';
                                                                }
