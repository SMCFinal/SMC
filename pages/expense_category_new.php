                    ...
                    <div class="card-body">
                        <form method="POST">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" placeholder="Category" type="text" value="" id="example-text-input" name="areaName" required="">
                                </div>
                            </div><hr>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12" align="right">
                                    ...
                                    <button type="submit" class="btn btn-primary waves-effect waves-light" name="addArea">Add Expense Category</button>
                                </div>
                            </div>
                        </form>
...
while ($rowArea = mysqli_fetch_assoc($retArea)) {
	echo '
                                    <tr>
                                        ...
                                        <td class="text-center"><a href="expense_category_edit.php?id=' . $rowArea['id'] . '" type="button" class="btn text-white btn-warning waves-effect waves-light">Edit</a></td>
                                    </tr>
                                    ';
}
?>
